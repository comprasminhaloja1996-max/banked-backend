...
/* ========================================================
   ...
   Isso resolve o erro vermelho de "Blocked by CORS policy"
======================================================== */
app.use(cors({
    origin: '*', // Aceita QUALQUER site ou celular
...
/* ========================================================
   3. CONSULTAR SALDO (A ROTA QUE ESTAVA FALTANDO)
======================================================== */
...
/* ========================================================
   4. INICIAR JOGO (Desconta Vida) - A ROTA DO ERRO
======================================================== */
app.post('/jogo/inicio', async (req, res) => {
  ...
  try {
    ...
    if (result.rows.length === 0) {
        // Se não retornou nada, ou não tem user ou não tem vida
